...
class CommandList(commands.Cog):
    ...
    @discord.app_commands.command(name="help-command", description="EvexDeveloppers SupportBotが提供するすべてのコマンドを表示します。")
    async def command_list(self, interaction: discord.Interaction):
        """Botが提供するすべてのコマンドとその説明を表示"""
        embed = discord.Embed(title="EvexDeveloppers SupportBotのコマンド一覧", description="以下はEvexDeveloppers SupportBotが提供するコマンドとその説明です。", color=discord.Color.green())
